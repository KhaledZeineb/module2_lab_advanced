...
public class StudentController {
    ...
    public String listAllStudents(Model model) {
        model.addAttribute("students", studentService.getAllStudents());
        return "students/list"; // Pointez vers votre template pour afficher la liste des étudiants
    }
    ...
    public String viewStudent(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("student", student); // Correction ici : on utilise l'étudiant récupéré, pas un nouveau
        return "students/view"; // Correction : utiliser une vue appropriée
    }
